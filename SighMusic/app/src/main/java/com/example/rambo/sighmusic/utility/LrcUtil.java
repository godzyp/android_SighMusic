...
import static com.example.rambo.sighmusic.utility.Constants.URL_GET_MUSIC_ID;
import static com.example.rambo.sighmusic.utility.Constants.URl_GET_MUSIC_LRC;

/**
 * technologically...
 * support format .lrc .txt
 * could use netease api to get lyrics or local lyric files
 * but... the network based method has resolutions already
 * theoretically, the local file based method is functional
 */
public class LrcUtil {
    ...
    /**
     * untested method, unused, deprecated.
     * QAQ this is just an api
     * @param f
     */
    @Deprecated
    ...
    /**
     * Untested, unused deprecated
     * Can not use local lrc seems so stupid when you can using online lyrics.
     * I don't know this api is runnable or not.
     * @param file
     */
    @Deprecated
